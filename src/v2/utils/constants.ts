...
export const DEPLOY_PURCHASED_SCRIPT =
    "/v2/scripts/deploy/deploy-to-purchased-servers.js";
export const PURCHASE_SERVER = "/v2/scripts/purchase.js";
...
export const SERVER_WORKER_SCRIPT = "/v2/scripts/hacking/server-worker.js";
